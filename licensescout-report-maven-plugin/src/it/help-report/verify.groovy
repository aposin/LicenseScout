...
searchStrings.put("licensescout-report:report", Boolean.FALSE);
searchStrings.put("checkedArchivesFilename (Default: checkedarchives.csv)", Boolean.FALSE);
searchStrings.put("User property: scanDirectory", Boolean.FALSE);

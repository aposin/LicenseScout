...
/**
 * Unit test for {@link StandardReportExporterFactory}.
 *
 */
public class StandardReportExporterFactoryGetReportExporterTest
     ...
     */
    public StandardReportExporterFactoryGetReportExporterTest(OutputFileType outputFileType,
    ...
    protected IReportExporterFactory createFactory() {
        return new StandardReportExporterFactory();
    }

    @Parameters
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] { //
                { OutputFileType.CSV, CsvExporter.class }, //
                { OutputFileType.HTML, HtmlExporter.class }, //
                { OutputFileType.TXT, TxtExporter.class }, //
        });
    }
}

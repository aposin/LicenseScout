...
public class Archive implements Comparable<Archive> {
    ...
    /**
     * Clears the list of resulting licenses.
     */
     ...
     */
    public final Set<License> getResultingLicenses() {
        return resultingLicenses.keySet();
    }

    /**
     * Sets the collection of resulting licenses to the content of the collection of detected licenses.
     */

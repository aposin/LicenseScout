...
/**
 * Unit tests for {@link ArchiveIdentifierPattern}.
 */
public class ArchiveIdentifierPatternTest {

    /**
     * Test method for {@link ArchiveIdentifierPattern#toString()}.
     */
    @Test
    ...
    /**
     * Test method for {@link ArchiveIdentifierPattern#hashCode()}.
     */
    @Test
    ...
    public void testHashCodeDifferentArchiveType() {
        final ArchiveIdentifierPattern ai1 = new ArchiveIdentifierPattern(ArchiveType.JAVA,
                PatternType.PATTERN_ON_FILENAME, "abc");
        final ArchiveIdentifierPattern ai2 = new ArchiveIdentifierPattern(ArchiveType.JAVASCRIPT,
                PatternType.PATTERN_ON_FILENAME, "abc");
    ...
    public void testHashCodeDifferentPatternType() {
        final ArchiveIdentifierPattern ai1 = new ArchiveIdentifierPattern(ArchiveType.JAVA,
                PatternType.PATTERN_ON_FILENAME, "abc");
        final ArchiveIdentifierPattern ai2 = new ArchiveIdentifierPattern(ArchiveType.JAVA, PatternType.PATTERN_ON_PATH,
                "abc");
        Assert.assertNotEquals("hashCode()", ai1.hashCode(), ai2.hashCode());
    }
    ...
    public void testHashCodeDifferentRegex() {
        final ArchiveIdentifierPattern ai1 = new ArchiveIdentifierPattern(ArchiveType.JAVA,
                PatternType.PATTERN_ON_FILENAME, "abc");
        final ArchiveIdentifierPattern ai2 = new ArchiveIdentifierPattern(ArchiveType.JAVA,
                PatternType.PATTERN_ON_FILENAME, "def");
        Assert.assertNotEquals("hashCode()", ai1.hashCode(), ai2.hashCode());
    }

    /**
     * Test method for {@link ArchiveIdentifierPattern#equals(Object)}.
     */
    @Test
